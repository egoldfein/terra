...
// 	mockSvc := &mockDynamoDBClient{}
// 	var dbFake = &dynamodbfakes.FakeAPI{
// 		PutStub: func(ctx context.Context, tableName string, item map[string]*dynamodb.AttributeValue) (map[string]*dynamodb.AttributeValue, error) {
// 			input := &dynamodb.PutItemInput{
// 				Item:      item,
// 				TableName: aws.String(tableName),
// 			}
// 			output, err := mockSvc.MockPut(input)
// 			return output.Item, err
// 		},
// 	}

// 	ctx := context.Background()
// 	item := user_plants.Plant{
// 		ID:   uuid.New().String(),
// 		PlantListID: "",
// 		PlantID: "",
// 		Name: "",
...
// 	input, err := dynamodbattribute.MarshalMap(item)
// 	output, err := dbFake.Put(ctx, "tableName", input)
// 	assert.NoError(t, err)
// 	assert.NotNil(t, output)
